    ...
    ?><div class="wrap">
        ...
        <div class="fpf-admin_wrapper">
            <div class="<?php echo $allTabsClass ?>" id="<?php echo $tab1Id ?>" style="display:<?php echo ($fpf_shown_tab == 1 ? "block" : "none") ?>">
                ...
                <?php _e('To get started, you must first connect with your Facebook account using the link below.  Once connected, you can create a gallery by making a new Wordpress post or page, switching to the HTML Editor (now called the Code Editor in Wordpress 5.0, available under the "3 dots" menu at the top right), and pasting in one line of special HTML, like this:', 'facebook-photo-fetcher') ?><br /><br />
            ...
            <div class="<?php echo $allTabsClass ?>" id="<?php echo $tab2Id ?>" style="display:<?php echo ($fpf_shown_tab == 2 ? "block" : "none") ?>">
                ...
                <?php else : ?>
                    ...
                    <form name="listalbums" method="post" action="">
                        ...
                        <?php echo sprintf(__("Your User ID is %s.  To get a page's ID, you can use findmyfbid.com - or visit the page &amp; click 'About,' and it should be listed at the bottom. Note that you can only fetch photos from pages of which you are an admin.", 'facebook-photo-fetcher'), "<b>$user->id</b>", "<b>facebook.com/photos/a.123.456.789</b>", "789") ?><br /><br />
