			...
			!empty($zerif_copyright) || !empty($zerif_socials_instagram) ):
						...
						if(!empty($zerif_socials_facebook) || !empty($zerif_socials_twitter) || !empty($zerif_socials_linkedin) || !empty($zerif_socials_behance) || !empty($zerif_socials_dribbble)):
							...
							if( !empty($zerif_socials_facebook) ):
								echo '<li><a'.$attribut_new_tab.' href="https://www.facebook.com/Mnailsbeaute-553117668229700/?fref=ts"><span class="sr-only">' . __( 'Go to Facebook', 'zerif-lite' ) . '</span> <i class="fa fa-facebook"></i></a></li>';
							endif;
...
<a style="font-size: 6px;" href="https://www.freepik.com/free-photos-vectors/logo" target="_blank">Logo vector created by Harryarts - www.freepik.com</a>
