<?php get_header(); 
	...
	if ( get_option( 'show_on_front' ) == 'page' ) {
		...
		if(isset($_POST['submitted']) && !defined('PIRATE_FORMS_VERSION') && !shortcode_exists( 'pirate_forms' ) ) :
				...
				$datePreference = "";
				if(trim($_POST['datePreference']) != ''):
					$datePreference = trim($_POST['datePreference']);
				endif;
				...
				if(!isset($hasError)):
					...
					if(isset($emailTo) && $emailTo != ""):
						...
						if ( zerif_is_localhost() ) {
							...
							$headers = 'From: '.$name.' <marta.lima.x.y@hotmail.com>' . "\r\n" . 'Reply-To: ' . $email;
						...
						wp_mail($emailTo, "Novo pedido de marcação: ".$name, $body, $headers);
...
<?	if(isset($_GET['test'])) {
	...
	?>
	<div style="min-height:350px;background:white;">
	...
	<?php
		...
		zerif_after_latest_news_trigger();
				...
				<section class="contact-us" id="contact">
					<div class="container">
						...
						?>
							...
							<h2 style="color: #fff;">Fixer votre rendez-vous</h2>
							<!-- CONTACT FORM-->
							<div class="row">
								...
								if(isset($emailSent) && $emailSent == true) :
									...
									echo '<div class="notification success"><p>'.__('Merci, votre message a été envoyé avec succès!','zerif-lite').'</p></div>';
								...
								<form role="form" method="POST" action="" onSubmit="this.scrollPosition.value=(document.body.scrollTop || document.documentElement.scrollTop)" class="contact-form">
									...
									<div class="col-lg-6 col-sm-6 zerif-rtl-contact-name" data-scrollreveal="enter left after 0s over 1s">
										<label for="myname" class="screen-reader-text"><?php /*_e( 'Nom', 'zerif-lite' );*/ ?></label>
										<input required="required" type="text" name="myname" id="myname" placeholder="Nom Complet<?php /*_e('Nom','zerif-lite');*/ ?>" class="form-control input-box" value="<?php if(isset($_POST['myname'])) echo esc_attr($_POST['myname']);?>">
									</div>

									<div class="col-lg-6 col-sm-6 zerif-rtl-contact-email" data-scrollreveal="enter left after 0s over 1s">
										<label for="myemail" class="screen-reader-text">E-mail<?php /* _e( 'Email', 'zerif-lite' );*/ ?></label>
										<input required="required" type="email" name="myemail" id="myemail" placeholder="Email<?php /*_e('Email','zerif-lite');*/ ?>" class="form-control input-box" value="<?php if(isset($_POST['myemail'])) echo is_email($_POST['myemail']) ? $_POST['myemail'] : ""; ?>">
									</div>

									<div class="col-lg-6 col-sm-6 zerif-rtl-contact-subject" data-scrollreveal="enter left after 0s over 1s">
										<label for="mysubject" class="screen-reader-text"><?php _e( 'Objet du message', 'zerif-lite' ); ?></label>
										<input required="required" type="text" name="mysubject" id="mysubject" placeholder="Numéro de Téléphone<?php /* _e('Objet du message','zerif-lite');*/ ?>" class="form-control input-box" value="<?php if(isset($_POST['mysubject'])) echo esc_attr($_POST['mysubject']);?>">
									</div>

									<div class="col-lg-6 col-sm-6 zerif-rtl-contact-subject" data-scrollreveal="enter left after 0s over 1s">
										<label for="datePreference" class="screen-reader-text"><?php _e( 'Objet du message', 'zerif-lite' ); ?></label>
										<input type="date" name="datePreference" id="datePreference" placeholder="Préférences Rendez-vous<?php /* _e('Objet du message','zerif-lite');*/ ?>" class="form-control input-box" >
									</div>

									<div class="col-lg-12 col-sm-12" data-scrollreveal="enter right after 0s over 1s">
										<label for="mymessage" class="screen-reader-text"><?php _e( 'Message', 'zerif-lite' ); ?></label>
										<textarea name="mymessage" id="mymessage" class="form-control textarea-box" placeholder="<?php _e('Message','zerif-lite'); ?>"><?php if(isset($_POST['mymessage'])) { echo esc_html($_POST['mymessage']); } ?></textarea>
									</div>
			...
			?>
				...
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2745.0079368025563!2d6.6032132158552885!3d46.52774477912794!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x478c31cf7a9e1b89%3A0x54b294cf0127652a!2sAvenue%20de%20Morges%2090%2C%201004%20Lausanne!5e0!3m2!1sfr!2sch!4v1574960687814!5m2!1sfr!2sch" width="100%" height="300" frameborder="0" style="border:0;margin-bottom: -8px;" allowfullscreen></iframe>
			
<?/*				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1540.82011727008!2d6.635645548451436!3d46.5194050936986!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x478c2e345ddd5475%3A0x7a8aa4ae3419637b!2sLook+For+You+-+Beauty+Center!5e0!3m2!1spt-PT!2sch!4v1512328749562" width="100%" height="300" frameborder="0" style="border:0;margin-bottom: -8px;" allowfullscreen></iframe><?*/?>
			
				<?/*<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d686.1106886694422!2d6.5801604292565345!3d46.53892772118997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x478c31a1b6b79715%3A0x124dbc244937087d!2sPolly+Sa!5e0!3m2!1spt-PT!2sch!4v1502542450726" width="100%" height="300" frameborder="0" style="border:0;margin-bottom: -8px;" allowfullscreen></iframe><?*/?>
