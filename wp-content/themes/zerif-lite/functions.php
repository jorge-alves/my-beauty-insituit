...
function zerif_scripts() {    
    ...
    wp_enqueue_style('zerif_bank_font', get_template_directory_uri() . '/fonts/bank/stylesheet.css', array(), 'v1');
...
class zerif_ourfocus extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        <div class="col-lg-3 col-sm-3 focus-box" data-scrollreveal="enter left after 0.15s over 1s">
            ...
            <!-- FOCUS HEADING -->
				<div>
					<img src="http://my-beauty-institut.com/wp-content/uploads/2020/02/text_line.png"/>
				</div>
			<?php 
